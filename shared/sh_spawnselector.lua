...
BOUTIQUE.Config = {
    ...
    spawns = {
        {
            name = "Airport",
            adress = "Aéroport de Los Santos",
            smalldescription = "Aéroport international de Los Santos",
            description = "Atterrissez sur l'aéroport de Los Santos pour commencer votre aventure dans le luxe et le confort.",
        ...
        {
            name = "Paleto Bay",
            adress = "Motel Paleto Bay",
            smalldescription = "Reception du motel Paleto Bay",
            description = "Un motel avec vue panoramique sur Paleto Bay, idéal pour commencer votre aventure dans le luxe et le confort.",
        ...
        {
            name = "Sandy Shores",
            adress = "Petite maison",
            smalldescription = "Petite maison à Sandy Shores",
            description = "Une petite maison avec vue panoramique sur Sandy Shores, idéal pour commencer votre aventure dans le luxe et le confort.",
